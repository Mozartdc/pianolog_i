...
} from "./chunk-GR34L6GM.js";
import "./chunk-BHPXHRDX.js";
import {
...
import {
  ...
  useControlled,
  useId
} from "./chunk-QNCB564W.js";
import {
  useEventCallback_default,
  useForkRef
} from "./chunk-D5WC7ECF.js";
import {
  warnOnce
} from "./chunk-TTGKUZR6.js";
import "./chunk-AFOBVG7T.js";
import {
  useThemeProps
} from "./chunk-XAK5FABU.js";
import {
...
var useIsDateDisabled = ({
  ...
  const adapter = usePickerAdapter();
  return React12.useCallback((day) => validateDate({
    adapter,
    value: day,
    timezone,
    props: {
...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React13.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
  ...
  const [calendarState, dispatch] = React13.useReducer(reducerFn, {
    isMonthSwitchingAnimating: false,
  ...
  const onMonthSwitchingAnimationEnd = React13.useCallback(() => {
    dispatch({
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React16.useMemo(() => adapter.getMonth(day) !== currentMonthNumber, [adapter, day, currentMonthNumber]);
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React16.useMemo(() => selectedDays.filter((day) => !!day).map((day) => adapter.startOfDay(day)), [adapter, selectedDays]);
...
var MonthCalendar = React19.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React19.useMemo(() => adapter.getMonth(now), [adapter, now]);
  ...
  const [focusedMonth, setFocusedMonth] = React19.useState(() => selectedMonth || adapter.getMonth(referenceDate));
...
var YearCalendarButton = React20.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var YearCalendar = React21.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React21.useMemo(() => adapter.getYear(now), [adapter, now]);
  ...
  const [focusedYear, setFocusedYear] = React21.useState(() => selectedYear || adapter.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime10.jsxs)(React23.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime10.jsxs)(React23.Fragment, {
  children: [(0, import_jsx_runtime10.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime10.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var PickersCalendarHeader = React26.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  const translations = usePickerTranslations();
  const adapter = usePickerAdapter();
  const props = useThemeProps({
    props: inProps,
...
var DateCalendar = React27.forwardRef(function DateCalendar2(inProps, ref) {
  const adapter = usePickerAdapter();
  const {
    ownerState
  } = usePickerPrivateContext();
  ...
  const prevOpenViewRef = React27.useRef(view);
  React27.useEffect(() => {
  ...
  const selectedDays = React27.useMemo(() => [value], [value]);
...
var PickersLayout = React35.forwardRef(function PickersLayout2(inProps, ref) {
  ...
  return (0, import_jsx_runtime19.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime19.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime19.jsxs)(React35.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime19.jsxs)(React35.Fragment, {
...
// node_modules/@mui/x-date-pickers/esm/StaticDatePicker/StaticDatePicker.js
var StaticDatePicker = React37.forwardRef(function StaticDatePicker2(inProps, ref) {
  var _a;
