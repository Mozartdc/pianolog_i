...
} from "./chunk-OSTO7VDZ.js";
import {
  useSlotProps_default
} from "./chunk-ZHAPJZF6.js";
import {
  CSSTransition_default,
  TransitionGroup_default
} from "./chunk-SW5V2OMR.js";
import "./chunk-A7ECLLTJ.js";
import {
  createSvgIcon
} from "./chunk-OPNZJVU3.js";
import {
  useControlled,
  useEventCallback_default,
  useForkRef,
  useId
} from "./chunk-UKCCHZBX.js";
import "./chunk-3XAHO2XK.js";
import {
  useThemeProps
} from "./chunk-LKWT7KU5.js";
import {
...
var useCalendarState = (params) => {
  ...
  const utils = useUtils();
  const reducerFn = React12.useRef(createCalendarStateReducer(Boolean(reduceAnimations), utils)).current;
...
function PickersSlideTransition(inProps) {
  ...
  return (0, import_jsx_runtime4.jsx)(PickersSlideTransitionRoot, {
    className: clsx_default(classes.root, className),
    childFactory: (element) => React14.cloneElement(element, {
...
var _excluded6 = ["parentProps", "day", "focusedDay", "selectedDays", "isDateDisabled", "currentMonthNumber", "isViewFocused"];
...
function WrappedDay(_ref) {
  ...
  const isDisabled = React15.useMemo(() => disabled || isDateDisabled(day), [disabled, isDateDisabled, day]);
  const isOutsideCurrentMonth = React15.useMemo(() => utils.getMonth(day) !== currentMonthNumber, [utils, day, currentMonthNumber]);
  ...
  const isFirstVisibleCell = React15.useMemo(() => {
  ...
  const isLastVisibleCell = React15.useMemo(() => {
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React15.useMemo(() => selectedDays.filter((day) => !!day).map((day) => utils.startOfDay(day)), [utils, selectedDays]);
  const transitionKey = `${currentYearNumber}-${currentMonthNumber}`;
  const slideNodeRef = React15.useMemo(() => React15.createRef(), [transitionKey]);
  const weeksToDisplay = React15.useMemo(() => {
...
var MonthCalendarButton = React16.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var useControlledValue = ({
  ...
  const inputTimezone = React17.useMemo(() => valueManager.getTimezone(utils, valueWithInputTimezone), [utils, valueManager, valueWithInputTimezone]);
  ...
  const valueWithTimezoneToRender = React17.useMemo(() => valueManager.setTimezone(utils, timezoneToRender, valueWithInputTimezone), [valueManager, utils, timezoneToRender, valueWithInputTimezone]);
...
var _excluded8 = ["autoFocus", "className", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "shouldDisableMonth", "readOnly", "disableHighlightToday", "onMonthFocus", "hasFocus", "onFocusedViewChange", "monthsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var _excluded9 = ["autoFocus", "classes", "disabled", "selected", "value", "onClick", "onKeyDown", "onFocus", "onBlur", "slots", "slotProps"];
...
var _excluded10 = ["autoFocus", "className", "classes", "value", "defaultValue", "referenceDate", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onChange", "readOnly", "shouldDisableYear", "disableHighlightToday", "onYearFocus", "hasFocus", "onFocusedViewChange", "yearsOrder", "yearsPerRow", "timezone", "gridLabelId", "slots", "slotProps"];
...
var _excluded12 = ["slots", "slotProps", "currentMonth", "disabled", "disableFuture", "disablePast", "maxDate", "minDate", "onMonthChange", "onViewChange", "view", "reduceAnimations", "views", "labelId", "className", "classes", "timezone", "format"];
...
function useValueAndOpenStates(parameters) {
  ...
  } = React29.useRef(defaultValueProp);
  const {
    current: isValueControlled
  } = React29.useRef(valueProp !== void 0);
  const {
  ...
  const viewValue = React29.useMemo(() => valueManager.cleanValue(utils, state.clockShallowValue === void 0 ? value : state.clockShallowValue), [utils, valueManager, state.clockShallowValue, value]);
  return {
    timezone,
    state,
    setValue,
...
var usePicker = ({
  ...
  const {
    current: initialView
  } = React30.useRef(openTo ?? null);
  const [triggerElement, triggerRef] = React30.useState(null);
  ...
  const ownerState = React30.useMemo(() => ({
  ...
  const triggerStatus = React30.useMemo(() => {
  ...
  const contextValue = React30.useMemo(() => _extends({}, actionsContextValue, {
    value,
    timezone,
    open: state.open,
    views,
  ...
  const privateContextValue = React30.useMemo(() => ({
    dismissViews,
    ownerState,
    hasUIView,
    getCurrentViewMode,
  ...
  const fieldPrivateContextValue = React30.useMemo(() => ({
    formatDensity,
    enableAccessibleFieldDOMStructure,
    selectedSections,
    onSelectedSectionsChange,
  ...
  const renderCurrentView = () => {
    ...
    if (RendererInterceptor) {
      return (0, import_jsx_runtime15.jsx)(RendererInterceptor, {
        viewRenderers,
        popperView,
        rendererProps
      });
...
function PickersActionBarComponent(props) {
  ...
  return (0, import_jsx_runtime16.jsx)(PickersActionBarRoot, _extends({}, other, {
    children: buttons
  }));
}
...
var PickersLayout = React34.forwardRef(function PickersLayout2(inProps, ref) {
  ...
  return (0, import_jsx_runtime19.jsxs)(PickersLayoutRoot, {
    ...
    children: [orientation === "landscape" ? shortcuts : toolbar, orientation === "landscape" ? toolbar : shortcuts, (0, import_jsx_runtime19.jsx)(PickersLayoutContentWrapper, {
      ...
      ownerState,
      children: variant === "desktop" ? (0, import_jsx_runtime19.jsxs)(React34.Fragment, {
        children: [content, tabs]
      }) : (0, import_jsx_runtime19.jsxs)(React34.Fragment, {
...
var useStaticPicker = (_ref) => {
  ...
  const renderPicker = () => {
    var _a, _b;
    return (0, import_jsx_runtime20.jsx)(PickerProvider, _extends({}, providerProps, {
...
// node_modules/@mui/x-date-pickers/esm/StaticDatePicker/StaticDatePicker.js
var StaticDatePicker = React36.forwardRef(function StaticDatePicker2(inProps, ref) {
  var _a;
